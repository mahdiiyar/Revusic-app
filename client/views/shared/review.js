Template.review.events({
    'click [data-id=remove-review]': function(event, template) {
        let self = this;
        ...
        swal({
            ...
            Meteor.call('reviews.remove', self._id, (error, result) => {
                if (error) {
                    Bert.alert(error.reason, 'danger', 'growl-top-right');
                } else {
                    Bert.alert('Review successfully removed', 'success', 'growl-top-right');
        }
        });
        });
    }
